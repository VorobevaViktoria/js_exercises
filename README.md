...
1. Первую часть задания повторить по уроку. Создание функций start, rememberMyFilms и detectPersonalLevel.
...
## Практика. Часть 5. Задание на отработку действий со страницей
Задание на урок:
...
## Практика. Часть 6. Используем события на странице проекта
Задание на урок:
